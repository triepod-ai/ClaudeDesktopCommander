...
import { SearchRepositoriesSchema, GetFileContentsSchema, CreateIssueSchema, GetIssueSchema } from './tools/github-schemas.js';
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    try {
        ...
        // Log the error
        logError(`Error executing tool ${request.params.name}`, error instanceof Error ? error : new Error(errorMessage), { toolName: request.params.name });
        const response = {
