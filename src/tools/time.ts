...
// Time zone utilities
function getZoneInfo(timezoneName: string): string {
  try {
...
function getCurrentLocalTimezone(): string {
...
export async function getCurrentTime(args: unknown) {
  try {
...
export async function convertTime(args: unknown) {
  try {
